...
_INTENT_RULES = (
    ...
    },
    {
        ...
        "patterns": (
            r"\bmore synth(?:s|esizers?|etic)?\b",
            r"\bmore electronic (?:sound|material)s?\b",
    ...
    },
    {
        ...
        "patterns": (
            ...
            r"\bmore\b(?:(?!\bless\b)[^.]){0,80}\b(?:arpegg?i?os?|arps?)\b",
        ),
    ...
    },
    {
        ...
        "patterns": (
            ...
            r"\bless\b(?:(?!\bmore\b)[^.]){0,80}\b(?:blur|blurry|muddy|muddiness)\b",
        ),
    ...
    },
    {
        ...
        "patterns": (
            ...
            r"\bhigher tempo\b",
            r"\bmore\b(?:(?!\bless\b)[^.]){0,80}\b(?:energy|activity)\b",
        ),
...
_UNICODE_INTENT_RULES = (
    ...
    },
    {
        ...
        "patterns": (
            ...
            r"\bλιγοτερ\w*\b(?:(?!\bπερισσοτερ\w*\b)[^.]){0,80}\bθολουρα\b",
        ),
        "updates": {"layer_clarity_weight": 0.08},
    },
    {
